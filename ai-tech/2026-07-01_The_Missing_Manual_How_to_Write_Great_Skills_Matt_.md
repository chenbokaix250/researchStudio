# The Missing Manual: How to Write Great Skills - Matt Pocock

**日期**: 2026-07-01  
**来源**: YouTube  
**链接**: https://youtube.com/watch?v=UNzCG3lw6O0
...
```
skill.md (主文件，保持精简)
├── description → 进入 Agent 上下文（模型触发时）
└── skill.md → 包含 steps + reference pointers
    └── external references (仅相关分支需要时加载)
```
...
**Matt Pocock 的技能如此精简的秘诀**：删除测试 + 压缩成引导词 + 无无关内容 + 无沉积物
